...
class Person {
    ...
    public void getInfo() {
        String data = "Меня зовут " + this.name + "\n";
        if (this.mother != null) {
            data += "Имя моей мамы: " + this.mother.name + "\n";
        }
        if (this.father != null) {
            data += "Имя моего папы: " + this.father.name + "\n";
        }
        if (this.mother.mother != null) {
            data += "У меня две бабушки: бабушка " + this.mother.mother.name + " и ";
        }
        if (this.father.mother != null) {
            data += this.father.mother.name + "\n";
        }
        if (this.father.father != null) {
            data += "У меня два дедушки: дедушка " + this.father.father.name + " и ";
        }
        if (this.mother.father != null) {
            data += this.mother.father.name + "\n";
        }
